    ...
    <div class="variant-list variant-list--comparison">
        <?php foreach($variants as $variant):?>
            <div class="variant-list__el">
                <label class="variant-opts"><?= get_the_post_thumbnail( get_field('review', $variant->ID), 'thumbnail', array('class' => 'variant-opts__img') ); ?>
                <div class="variant-opts__title"><?= $variant->post_title?></div>
